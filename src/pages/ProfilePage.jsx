                    ...
                    <h1 className="flex items-center gap-1 text-lg font-medium">
                      ...
                      <Link to={"/airbnbPolicies"}>
                        <div className="relative inline-block group">
                          ...
                          />
                          <div className="hidden group-hover:block bg-gray-800 text-white text-sm p-1 rounded absolute top-full left-1/2 transform -translate-x-1/2 translate-y-2 opacity-0 transition-opacity duration-300">
                            Info
                          </div>
                        </div>
                      </Link>
