...
const ResetPassword = () => {
    ...
    return (  
            <>
              ...
              <motion.div initial={{opacity:0,y:50}} animate={{opacity:1,y:0}} transition={{duration:1,type:'spring',stiffness:100}} className="border border-primary rounded-2xl shadow-xl p-8  w-[70%]">
