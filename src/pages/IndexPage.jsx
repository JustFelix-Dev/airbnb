...
const IndexPage = () => {
  ...
  return (
         ...
         { !loading &&
          ( <motion.div variants={renderOnce ? placesVariants : {}} initial='hidden' animate='visible' className="mt-8 grid max-w-8xl pt-4 px-2 sm:px-6 md:px-10 lg:px-12 gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {
