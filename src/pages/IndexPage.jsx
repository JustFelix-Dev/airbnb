        ...
        >
          {allPlaces?.length > 0 &&
            allPlaces.map((place, idx) => (
              ...
              <div className=" absolute p-1 z-10 cursor-progress right-2 top-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[13px] h-[13px] " fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
