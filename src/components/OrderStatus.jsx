                ...
                <AnimatePresence>
                    ...
                    </AnimatePresence> 
                    {
                      !isLoading && order && (
                              <>
                              <div className="">
                              <img className="absolute opacity-10 max-w-[100%] -z-10 top-[42%] left-[30%] sm:top-[37%] sm:left-[37%] h-[130px] w-[130px] sm:h-[300px] sm:w-[300px]" src="/images/airbnb.png" alt="airbnb-logo" />
