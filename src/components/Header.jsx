             ...
             <div className='flex items-center gap-5 '>
              ...
              <Link to={ user ? '/account' : '/login'} className='flex items-center gap-2 border border-gray-300 rounded-full px-2 py-1'>
                ...
                <div className='flex items-center gap-1 justify-center'>
                 ...
                 <div className='hidden md:block'>{ user && user.admin && <div><svg width={10} height={10} fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
